...
public class ThreadUtils {
    public static final ExecutorService THREAD_POOL = new ThreadPoolExecutor(
            ...
            Constants.THREAD_POOL_TIME_WAIT,
            TimeUnit.SECONDS,
            new ArrayBlockingQueue<>(Constants.THREAD_POOL_BLOCKING_QUEUE_SIZE),
            new ThreadFactoryBuilder().setNameFormat("Spring-Cloud-Thread-").build());
}
